...
function generateAbout(){
    ...
    <p class="body-par">
        I am a software engineer from Los Angeles, CA. I build full-stack mobile-first web applications using the PERN stack. My introduction to web design was back in the fifth grade when I made a website for fun. I later got in trouble for that website, when my mom had found the section titled 'Yo mama jokes.' Later on, in middle school I took 2 years of computer classes as an elective. There I had learned Illustrator, Photoshop, Flash, and Dreamweaver. After that, I hadn't done much until freshman year at UCSB, where I took some intro CS courses. I had considered switching from Pre-Math to CS as a major, but interestingly took an entirely different alternate route in the Humanities, majoring in Religous Studies. During my last quarter at UCSB, I had again rekindled my interest in CS, taking a course titles Data Structures & Algorithms taught in C++. After graduating (Class of 2019), I decided to enroll in a coding bootcamp to continue learning. I enrolled in Thinkful's Engineering Immersion program, where I learned most of the skills I use today. 
